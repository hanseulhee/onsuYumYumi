...
const stores: IStore[] = [
  {
    ...
    time: "정보없음",
    menu:["생삼겹살", "갈매기살", "항정살", "돼지껍데기", "물냉면", "비빔냉면", "흑돼지 소금구이", "왕갈비", "진갈비살", "소막창"]
  },
  {
    name: "토마토",
    summary: "성공회대생 혼밥성지",
    ...
    menu: ["큐브스테이크 덮밥", "소불고기덮밥", "수라한상도시락", "치킨마요", "숯불곱창마요", "마늘간장치킨도시락", "불고기비빔밥","참치마요"]
  },
  {
    name: "썬더치킨",
    ...
    time: "매일 16:00 - 01:00",
    menu: ["파닭치킨", "후라이드치킨", "양념치킨", "반반치킨", "간장치킨", "마늘치킨", "불닭치킨", "모듬감자"]
  },
  {
    name: "맷돌손두부",
    summary: "온수동 순두부 맛집",
    ...
    menu:["옛날두부찌개전골", "만두 두부 전골", "두부전골", "두부제육", "해물순두부", "김치순두부", "콩비지", "청국장", "두부김치"]
  },
  {
    name: "쎼쎼",
    summary: "진정한 중화요리전문점",
    ...
    time: "정보없음",
    menu: ["홍합짬뽕", "옛날짜장", "홍합우동", "야끼짬뽕","쟁반짜장", "짬짜면", "짬뽕국밥", "깐풍기", "라조기", "양장피", "찹쌀탕수육"]
  },
  {
    name: "미스터동",
    ...
    time: "정보없음",
    menu:["짜장면", "짬뽕",  "삼선짬뽕","간짜장", "삼선우동", "삼선울면", "기스면", "라조기", "매운 쟁반 짜장 (2인 이상)", "잡채밥"]
  },
  {
    name: "오구쌀피자",
    ...
    location: "서울 구로구 연동로 312",
    time: "정보없음",
    menu: ["반미터-통새우피자", "반미터-불새피자", "반미터-통감자새우피자", "베이컨듬뿍피자", "순살치킨", "반반피자",  "짜장떡볶이", "콤비네이션"]
  },
  {
    name: "터프네이모",
    ...
    time: "정보없음",
    menu: ["닭갈비", "곱창볶음", "번데기", "닭똥집", "꼼장어구이", "우삼겹", "골뱅이무침", "돼지껍데기", "오돌뼈", "낙지볶음", "닭볶음탕"]
  },
  {
    name: "모메존 칼국수",
  ...
  },
  {
    ...
    time: "정보없음",
    menu: ["직화구이삼겹", "꼼장어양념구이", "꼼장어소금구이", "닭발구이","삼겹살", "왕갈비", "돼지껍데기", "주물럭", "소막창구이", "쭈꾸미", "잔치국수"]
  ...
  },
  {
    ...
    time: "정보없음",
    menu: ["봉구먹태", "봉구노가리", "봉구닭치킨", "크림생맥주", "오바디튀김", "궁물봉떡이", "오뎅키데스카", "쉬림프 빠삭빠삭 고로케", "한치구이"]
  },
  {
    name: "착한쌈싸",
    ...
    menu: ["점심특선 제육쌈밥", "한돈한판", "한돈왕구이", "한돈 생삼겹", "한우 차돌박이", "한우 꽃등심", "한우생고기 육회"]
  },
  {
    name: "냉삼집",
    ...
    location: "서울 구로구 경인로3길 77",
    time:"정보 없음",
    menu: ["강릉장칼국수", "대패삼겹살", "냉동삼겹살", "마약닭발", "냉면", "된장찌개"]
  },
  {
    name: "뚜레쥬르",
  ...
  },
  {
    ...
    time: "매일 15:00 ~ 24:00",
    menu: ["마포갈매기", "매콤갈매기", "마포삼겹살", "항정살", "돼지막창", "양념목살구이", "치즈갈매기", "돼지껍딱", "소갈비살", "고추장육회", "소갈비찜"]
  },
  {
    name: "다원국수",
  ...
  },
  {
    ...
    time: "매일: 11:00 ~ 20:00",
    menu: ["153 닭불고기 덮밥", "간장 닭불고기 덮밥", "불닭 불고기 덮밥", "간장 돼지불고기 덮밥", "고추장 돼지불고기 덮밥", "찰순대"]
  },
  {
    name: "의정부부대찌개",
    ...
    time:"정보없음",
    menu: ["부대찌개", "동태찌개", "된장찌개", "김치찌개", "닭한마리칼국수", "제육볶음", "청국장", "닭도리탕", "낙지전골"]
  },
  {
    name: "고바우",
  ...
  },
  {
    ...
    menu: ["그릴드 불갈비", "그릴드 불고기", "딥치즈 베이컨 포테이토", "핫치킨MVP", "베이컨 포테이토 피자", "딥치즈 베이컨", "피자", "필리새우"]
  },
  {
    name: "친구야호프",
    summary: "치킨같은 닭강정",
    ...
    menu: ["닭강정", "치즈계란말이", "돈가쓰", "탕수육", "닭갈비", "해물떡볶이", "후라이드치킨", "묵사발", "황도", "번데기"]
  },
  {
    name: "우방정육식당",
  ...
  },
  {
    ...
    time: "매일 11:00 ~ 21:30",
    menu: ["죽염삼계탕", "황기백숙", "옻닭", "황기오리", "옻오리", "유황오리", "로스구이"]
  },
  {
    name: "꼬꼬랑 호프랑",
  ...
  },
  {
    ...
    location: "서울 구로구 온수동 52-1",
    time:"정보없음",
    menu: ["참숯바비큐", "참숯순살바비큐", "보스 후라이드 치킨", "보스 양념 치킨", "보스 크리스피 치킨", "보스 땡초 치킨", "참숯바비큐날개", "보스훈제바비큐"]
  },
  {
    name: "피자마루",
    summary: "건강한 맛! 착한 가격!",
    ...
    time: "매일 11:00 ~ 23:00",
    menu: ["트러플 버섯 피자", "투움바 파스타 피자", "체다 소세지 피자", "바베큐 치킨 피자", "몬스터 불고기 피자", "페퍼로니 치즈폭탄피자", "스윗하새우"]
  },
  {
    name: "개성진순대",
    summary: "온수역 순댓국 맛집",
    ...
    time: "정보없음",
    menu: ["개성진순댓국", "얼큰순댓국", "김치순댓국", "오소리순댓국", "뼈해장국", "개성진정식"]
  },
  {
    name: "파리바게뜨",
  ...
  },
  {
    ...
    menu: ["제육컵밥", "불닭컵밥", "카레컵밥", "치킨마요컵밥", "김치컵밥", "두부김치", "참치김치계란", "소불고기", "김밥"]
  },
  {
    name: "본가칡냉면",
  ...
  },
  {
    ...
    menu: ["짜장면", "짬뽕", "간짜장", "쟁반짜장", "고추쟁반", "짜장밥", "마파밥", "등심탕수육", "양장피", "우거지갈비탕"]
  },
  {
    name: "하루",
    ...
    menu: ["부추전", "김치전", "오뎅탕", "부대찌개", "번데기탕", "닭볶음탕", "꼬막무침", "노가리", "나초", "계절과일", "먹태"]
